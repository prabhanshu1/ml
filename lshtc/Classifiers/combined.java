...
import java.util.TreeMap;
  ...
  class combined
 {
     ...
     void go() throws FileNotFoundException, IOException
     {
         ...
         Hashtable<String, String> vector = new Hashtable<>();
        
        
         FileReader fr = new FileReader("/home/vakhil/Desktop/fuck.csv");
    ...
    */
            ...
            String line ;
            int home=0;
            while(((line = jumbo.readLine()) != null) && home<=50)
             {
    ...
    for(int key : sorted_map.keySet() )
    {
        ...
        t++;
         ...
         {
             sjk.put(tiger.get(bf), new HashMap<String, Integer>());
         ...
         for(int bf=0;bf<tiger.size();bf++)
         {
          ...
          int baf=yuk.length-1;
            ...
            int common=0;
             ...
             double  P1 = (1.0* common1)/tale.size();
            double  R1= (1.0 *common1)/list.size();
              double score1;
              if(P1==0 && R1==0)
                  score1=0;
                 else
             ...
             else
             {
               ...
               System.out.println("Recall -> "+R1);
                  System.out.println("Benchmark score is "+score1);
                 
             }
            
             }
           System.out.println("Net score is " + finals/50);
           System.out.println("Net Precision Is "+Pf);
           System.out.println("Net Recall Is "+Rf);
